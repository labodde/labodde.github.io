---
title: 'Labo DDEs - Sistemas Dinámicos'
subtitle: 'Colombia - Argentina'
---

Laboratorio de ecuaciones diferenciales con retardo y sistemas dinámicos, con aplicaciones a las ciencias naturales y sociales.

Un grupo interdisciplinario colombiano-argentino, con intereses tanto teóricos como prácticos en las ecuaciones diferenciales con retardo, los sistemas dinámicos, y sus aplicaciones y simulaciones en las ciencias naturales y sociales

:::{note} Áreas de interés
- {term}`Ecuaciones Diferenciales con Retardo`.
- {term}`Sistemas Dinámicos`.
- Aplicaciones a las ciencas naturales y sociales.
:::
